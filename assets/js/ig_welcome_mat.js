...
function ig_createSplashContentsHtml() { // Feel free to edit the HTML below to match your site
  ...
  return '' +
    '<div class="igClose"><i class="material-icons">&#xE14C;</i></div>' +
    ...
    '  </ul>' +
        '  <div class="igWelcomeCTAButton"><button class="igClose">Start Shopping</button></div>' +
        '</div>' +
...
if(ig_flagLocation && ig_flagCode){
    igJq(document).ready(function(){
        ...
        if(typeof ig_setButtons != 'undefined' && ig_active === true){
            ig_setButtons();
        }
    });
}
